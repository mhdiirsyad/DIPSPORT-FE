        ...
        <li v-for="item in primaryNav" :key="item.to">
          ...
          >
            ...
            <span
              ...
              :class="[
                isActive(item) ? 'text-white' : 'text-blue-300 group-hover:text-white'
              ]"
            >
          ...
          <li v-for="item in secondaryNav" :key="item.label">
            ...
            >
              ...
              >
                ...
                >
                  <path d="M12 12C14.76 12 17 9.76 17 7C17 4.24 14.76 2 12 2C

9.24 2 7 4.24 7 7C7 9.76 9.24 12 12 12ZM12 14C8.13 14 2 16.17 2 20V22H22V20C22 16.17 15.87 14 12 14Z"/>
                </svg>
              </span>
